...
const API_URL = 'https://mempool.space/api/mempool';

function BitcoinMempoolDashboard() {
  ...
  if (loading) return <div>Loading Bitcoin mempool...</div>;
...
export default BitcoinMempoolDashboard;
