    ...
    try {
      ...
      if (chain === 'bitcoin') {
        ...
        balanceData = {
          address,
          balance: (
            balanceJson.chain_stats.funded_txo_sum -
            balanceJson.chain_stats.spent_txo_sum
          ).toString(),
          chain: 'bitcoin',
          symbol: 'BTC',
        };
    ...
    >
      ...
      {balance && (
        ...
        >
          <h3>Balance</h3>
          <p>
            <strong>Address:</strong> {balance.address}
          </p>
          <p>
            <strong>Balance:</strong>{' '}
            {formatValue(balance.balance, balance.symbol)}
          </p>
          <p>
            <a
